package com.twoa.tcebi.config;

import com.twoa.tcebi.securiry.BearerTokenServerAuthenticationConverter;
import com.twoa.tcebi.securiry.token.VerificationHandler;
...
public class WebSecurityConfig {
    ...
    private AuthenticationWebFilter bearerAuthenticationFilter(ReactiveAuthenticationManager authenticationManager) {
        ...
        bearerAuthenticationFilter.setServerAuthenticationConverter(new BearerTokenServerAuthenticationConverter(new VerificationHandler(secret)));
